<?php
namespace ZiUltimate\Elements\FluentForm;
...
class FluentForm extends UltimateElements {
	...
	public function get_name() {
		return __( 'Fluent Form Styler', 'ziultimate' );
	}
	...
	public function options( $options ) {
		...
		$options->add_option(
			...
			[
				'type' 			=> 'select',
				'default' 		=> -1,
				'title' 		=> __( 'Fluent Form', 'ziultimate' ),
				'description' 	=> __( "Make sure that you build at least one fluent form.", 'ziultimate' ),
		...
		$asterisk = $options->add_group(
			...
			[
				'type' 	=> 'accordion_menu',
				'title' => esc_html__('Asterisk', 'ziultimate')
			]
		);
		...
		$asterisk->add_option(
			...
			[
				'type' 		=> 'number_unit',
				'title'     => __( 'Gap Left', 'ziultimate' ),
				'description' => __( 'Set the value when asterisk is placed at right side of label.', 'ziultimate' ),
				'width' 	=> 50,
				'min' 		=> 0,
				'units' 	=> BaseSchema::get_units(),
				'responsive_options' => true,
		...
		$asterisk->add_option(
			...
			[
				'type' 		=> 'number_unit',
				'title'     => __( 'Gap Right', 'ziultimate' ),
				'description' => __( 'Set the value when asterisk is placed at left side of label.', 'ziultimate' ),
				'width' 	=> 50,
				'min' 		=> 0,
				'units' 	=> BaseSchema::get_units(),
				'responsive_options' => true,
		...
		$tb->add_option(
			...
			[
				'type' 		=> 'colorpicker',
				'title' 	=> __( 'Alt Background Color', 'ziultimate' ),
				'width' 	=> 50,
				'css_style' => [
					[
		...
		$tb->add_option(
			...
			[
				'type' 		=> 'colorpicker',
				'title' 	=> __( 'Alt Text Color', 'ziultimate' ),
				'width' 	=> 50,
				'css_style' => [
					[
						'selector' => '{{ELEMENT}} .ff-checkable-grids tbody>tr:nth-child(2n)>td',
		...
		$gdpr = $options->add_group(
			...
			[
				'type' 	=> 'accordion_menu',
				'title' => esc_html__('GDPR / T&C', 'ziultimate')
			]
		);
		...
		$nps_conf->add_option(
			...
			[
				'type' 		=> 'number_unit',
				'title' 	=> __( 'Hover Border Width', 'ziultimate' ),
				'min' 		=> 0,
				'units' 	=> BaseSchema::get_units(),
				'width' 	=> 50,
				'css_style' => [
		...
		$nps_conf->add_option(
			...
			[
				'type' 		=> 'colorpicker',
				'title' 	=> __( 'Hover Border Color', 'ziultimate' ),
				'width' 	=> 50,
				'css_style' => [
					[
						'selector' => $nps_selector . ' tbody tr td label:hover:after',
		...
		$nps_conf->add_option(
			...
			[
				'type' 		=> 'colorpicker',
				'title' 	=> __( 'Number Color', 'ziultimate' ),
				'width' 	=> 50,
				'css_style' => [
					[
		...
		$nps_conf->add_option(
			...
			[
				'type' 		=> 'colorpicker',
				'title' 	=> __( 'Number Hover Color', 'ziultimate' ),
				'width' 	=> 50,
				'css_style' => [
					[
		...
		$nps_conf->add_option(
			...
			[
				'type' 		=> 'colorpicker',
				'title' 	=> __( 'Selected BG Color', 'ziultimate' ),
				'width' 	=> 50,
				'css_style' => [
					[
		...
		$nps_conf->add_option(
			...
			[
				'type' 		=> 'colorpicker',
				'title' 	=> __( 'Selected No. Color', 'ziultimate' ),
				'width' 	=> 50,
				'css_style' => [
					[
						'selector' => $nps_selector . ' tbody tr td input[type=radio]:checked+label *',
		...
		$pb->add_option(
			...
			[
				'type' 		=> 'colorpicker',
				'title' 	=> __( 'Bar Active Color', 'ziultimate' ),
				'width' 	=> 50,
				'css_style' => [
					[
		...
		$pb_lbl = $pb->add_group(
			...
			[
				'type' 		=> 'panel_accordion',
				'title' 	=> esc_html__('Top Text', 'ziultimate'),
			]
		);
		...
		$pb->add_option(
			...
			[
				'type' 			=> 'number_unit',
				'units' 		=> BaseSchema::get_units(),
				'title' 		=> __( 'Margin Bottom', 'ziultimate' ),
				'min' 			=> 5,
				'responsive_options' => true,
				'css_style' 	=> [
					[
		...
		$box = $steps->add_option(
			...
			[
				'type' 		=> 'panel_accordion',
				'title' 	=> esc_html__('Square Box', 'ziultimate' )
			]
		);
		...
		$box_brd = $box->add_option(
			'box_brd',
			[
				'title'          => esc_html__( 'Border', 'ziultimate' ),
				'type'           => 'group',
		...
		$pb_hr = $steps->add_option(
			...
			[
				'type' 		=> 'panel_accordion',
				'title' 	=> esc_html__('Horizontal Line', 'ziultimate' )
			]
		);
		...
		$num = $steps->add_option(
			...
			[
				'type' 		=> 'panel_accordion',
				'title' 	=> esc_html__('Number', 'ziultimate' )
			]
		);
		...
		$steps_actv->add_option(
			...
			[
				'type' 		=> 'colorpicker',
				'title' 	=> __( 'Horizontal Line', 'ziultimate' ),
				'css_style' => [
					[
		...
		$rating->add_option(
			...
			[
				'type' 		=> 'colorpicker',
				'title' 	=> __( 'Default Color', 'ziultimate' ),
				'width' 	=> 50,
				'css_style' => [
					[
		...
		$rating->add_option(
			...
			[
				...
				'description' 	=> __( 'Set the spaces between stars', 'ziultimate' ),
				'min' 			=> 0,
				'units' 		=> BaseSchema::get_units(),
				'width' 		=> 50,
				'responsive_options' => true,
		...
		$rt_text = $rating->add_group(
			...
			[
				'type' 		=> 'panel_accordion',
				'title' 	=> __('Rating Text', 'ziultimate')
			]
		);
		...
		$rep->add_option(
			...
			[
				...
				'description' 	=> __( "Set the distance between two rows.", 'ziultimate' ),
				'width' 		=> 50,
				'min' 			=> 0,
				'responsive_options' => true,
				'css_style' 	=> [
		...
		$rep->add_option(
			...
			[
				'type' 			=> 'number_unit',
				'units' 		=> BaseSchema::get_units(),
				'title' 		=> __( 'Column Gap', 'ziultimate' ),
		...
		$sb->add_option(
			...
			[
				'type' 		=> 'colorpicker',
				'title' 	=> __( 'Line Color', 'ziultimate' ),
				'width' 	=> 50,
				'css_style' => [
					[
						'selector' => $sec_selector . ' hr',
	...
	public function enqueue_styles() {
		$this->enqueue_element_style( Utils::get_file_url( 'dist/css/elements/FluentForm/fluentform.css' ) );
	}
	...
	public function enqueue_scripts() {
		$this->enqueue_editor_script( Utils::get_file_url( 'dist/js/elements/FluentForm/editor.js' ) );
	}
	...
	public function before_render( $options ) {
		...
		if( $cb_smart_ui ) {
			$this->render_attributes->add( 'wrapper', 'class', 'zu-ff-cbui' );
		}

		$this->render_attributes->add( 'wrapper', 'class', 'zu-ff-styler' );
	}
	...
	public function render( $options ) {
		...
		if( $source_type == 'dynamic' ) {
			$ff_id = $options->get_value('ff_dymc_form');
		} else {
	...
	public function on_register_styles() {
		...
		$this->register_style_options_element(
			'ff_el_err',
			[
				'title'                   => esc_html__( 'Error Text', 'ziultimate' ),
				'selector'                => '{{ELEMENT}} .ff-el-is-error .text-danger',
				'allow_custom_attributes' => false,
				'allow_class_assignments' => false,
			]
		);
